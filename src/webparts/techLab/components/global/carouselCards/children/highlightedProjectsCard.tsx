...
const HighlightedProjectsCard = ({
    ...
    return (
        <Card className='card cardRight'>
            <CardActionArea>
                <img
                    src={""}
                    data-src={image ? image.Url : imagesAssets(`./Recurso_4.png`)}
            ...
            <CardActions className='cardAction'>
                <Typography variant="body2" color="textSecondary" component="p" className='textAction' style={(technologyId.length > 0) ? { height: 'auto' } : null}>
                ...
                </Typography>
                {
                    id ?
                        ...
                        linkResource ?
                            ...
                            :
                            <div style={{ width: '30%', height: '55px' }}>
...
export default HighlightedProjectsCard;
